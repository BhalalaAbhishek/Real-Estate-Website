                                ...
                                <div className="bg-white rounded p-3 gol">
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-6 col-xl-6">
                                            ...
                                            <a href="./Contact.html" className="btn btn-success py-3 px-4 me-2"><i
                                                    className="fa-solid fa-phone"></i> Make A
                                                Call</a>
                                            <a href="./Contact.html" className="btn btn-success py-3 px-5 mt-3 mt-sm-0 mt-lg-0 mt-md-0"><i
                                                    className="fa-solid fa-calendar"></i> Get
                                                Appointment</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="team rounded overflow-hidden box2">
                                        <div className="position-relative">
                                            ...
                                            <div className="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                                <a className="btn btn-square mx-1" href="https://www.facebook.com/"><i className="fab fa-facebook-f"></i></a>
                                                <a className="btn btn-square mx-1" href="https://twitter.com/i/flow/login"><i className="fab fa-twitter"></i></a>
                                                <a className="btn btn-square mx-1" href="https://www.instagram.com/accounts/login/"><i className="fab fa-instagram"></i></a>
                                            </div>
                                        </div>
                        ...
                        <div className="container py-5">
                            <div className="row">
                                <div className="col-lg-3 col-xl-3 col-md-6">
                                    ...
                                    <p className="mb-2"><i className="fa-solid fa-location-dot me-3"></i>147/148 Street,MotaVaracha,Surat</p>
                                    <p className="mb-2"><i className="fa-solid fa-phone me-3"></i>+91 8460819070</p>
                                    <p className="mb-2"><i className="fa-solid fa-envelope me-3"></i>propertyhub.gmail.com</p>
                                    <div className="pt-3">
                                        <a href="https://twitter.com/i/flow/login" className="btn btn-outline-light ro me-2"><i
                                                className="fa-brands fa-twitter"></i></a>
                                        <a href="https://www.facebook.com/" className="btn btn-outline-light ro me-2"><i
                                                className="fa-brands fa-facebook-f"></i></a>
                                        <a href="https://www.youtube.com/watch?v=FNsCWDip8lg" className="btn btn-outline-light ro me-2"><i
                                                className="fa-brands fa-youtube"></i></a>
                                        <a href="https://in.linkedin.com/" className="btn btn-outline-light ro me-2"><i
